...
FP_HuntFind is designed and built to be a way to bring together other FuzzPhyte packages to showcase a simple educational hunt and find game that uses an existing set of vocabulary systems, game systems, event systems, and analytic systems to construct a traditional Hunt and Find game.

## Setup & Design

FP_HuntFind brings together a lot of prior FuzzPhyte libraries, please see the installation folder (hidden in Unity) for the other FuzzPhyte packages.

### Software Architecture

FP_HuntFind <NEED DETAILS>.

### Ways to Extend

## Dependencies

Please see the [package.json](./package.json) file for more information as well as the [Dependencies.md](./Installation~/Dependencies.md) file for more FuzzPhyte requirements and the order in such to install.
...
* Audio files were probably generated using a paid version of ElevenLabs please do not redistribute this content without following the above dual license.
